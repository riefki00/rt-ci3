<div class="container-fluid">
    <div class="alert alert-success" role="alert">
        <h5><i class="fas fa-fw fa-book"></i> Form Data Diri</h5>
    </div>
    <?= $this->session->flashdata('pesan') ?>
    <form method="post" action="<?= base_url('user/administrasi/add_administrasi') ?>">
        ...
        <a href="<?= base_url('user/administrasi') ?>" class="btn btn-danger">Ulangi</a>
    </form>
</div>