<div class="container-fluid">
    <div class="alert alert-success" role="alert">
        <h5><i class="fas fa-fw fa-chart-area"></i> Form Tambah Pemasukkan</h5>
    </div>
    <form method="post" action="<?= base_url('admin/keuangan/add_uangmasuk') ?>">
        ...
        <div class="form-group">
            <label>Jumlah</label>
            <input type="number" name="jumlah" placeholder="Masukkan Jumlah Pemasukkan" class="form-control">
        ...
        <a href="<?= base_url('admin/keuangan') ?>" class="btn btn-danger">Kembali</a>
    </form>
</div>